...
<head>
<title>Yaruis Edit Supplier</title>
<meta charset="utf-8">
		...
		<div class="login">
			<div class="main-agileits">
				<div class="form-w3agile form1">
					<h3>Supplier</h3>
<%-- 					<c:url var="addAction" value="/editsup/{Supplier_id}"></c:url> --%>
					<form:form action="${contextPath}/addsup" modelAttribute="Supplier" method="post">
